<?php
function register_cpt_banners_etv()
{
  $labels = array(
    'name' => _x('Banners ETV', 'post type general name'),
  ...
  $args = array(
    'labels' => $labels,
    'description' => 'Cadastre os banners da página de ETV',
    'public' => true,
  ...
  register_post_type('banners_etv', $args);
}

add_action('init', 'register_cpt_banners_etv');
