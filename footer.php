<script async src="<?= get_stylesheet_directory_uri() . '/' . ASSETS_DIR ?>/js/main.js"></script>
<script defer src="<?= get_stylesheet_directory_uri() . '/' . ASSETS_DIR ?>/js/slides.js"></script>
